...
#     # Filter by pH range
#     if pH_min is not None:
#         query = query.filter(func.cast(Observation.parameters['pH'], Float) >= pH_min)
#     if pH_max is not None:
#         query = query.filter(func.cast(Observation.parameters['pH'], Float) <= pH_max)
#
#     # Filter by conductivity range
#     if conductivity_min is not None:
#         query = query.filter(func.cast(Observation.parameters['conductivity'], Float) >= conductivity_min)
#     if conductivity_max is not None:
#         query = query.filter(func.cast(Observation.parameters['conductivity'], Float) <= conductivity_max)
#
#     # Filter by DO range
#     if DO_min is not None:
#         query = query.filter(func.cast(Observation.parameters['DO'], Float) >= DO_min)
#     if DO_max is not None:
#         query = query.filter(func.cast(Observation.parameters['DO'], Float) <= DO_max)
#
#     # Filter by contaminants
#     if contaminants is not None:
#         for contaminant in contaminants:
#             query = query.filter(Observation.parameters['contaminants'].contains(contaminant))
#
#     filtered_observations = query.all()
#     return filtered_observations
...
#     # Example logic: Query observations based on specified pH, conductivity, DO, and contaminants
#
#     print("Inside quality param API")
#     query = db.query(Observation)
#     if pH_min is not None:
#         query = query.filter(Observation.parameters['pH'] >= pH_min)
#     if pH_max is not None:
